  ...
  <div id="main">
    ...
    <article id="content">
      ...
      <div class="col-2">
       ...
       $sql = "select * from production where name = 'RHM' ORDER BY vol desc limit 15, 30";

       $result = $conn->query($sql);
       while ($row = $result->fetch_object()) {
         echo "<div class='gallery'>
           <a class='' href='audio1.php? vol=$row->vol&amp;album=$row->name'>
              <img class='sizef' alt='RHM CD Vol $row->vol' src='$row->local_img' >  
