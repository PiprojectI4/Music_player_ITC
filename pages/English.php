  ...
  <div id="main">
    <header>
      <nav>
        <ul>
          ...
          <li class="active" ><a href="English.php">English Song</a></li>
    ...
    <article id="content">
      ...
      <div class="col-2">
        <a href="#" class="textColor"> <h2>English Song</h2></a>

          <?php 
          require_once('dbconfig.php');
          $sql = "select * from production where nationality = 'english' ORDER BY id desc limit 0, 15";
          $result = $conn->query($sql);
          while ($row = $result->fetch_object()) {
