  ...
  <div id="main">
    ...
    <article id="content">
      ...
      <div class="col-2">
       ...
       $next = $_GET['nb'];
       $some = $next + 15;
       $sql = "select * from production where name = 'RHM' ORDER BY vol desc limit $next, $some";
     //  echo "$some";
       $result = $conn->query($sql);
       while ($row = $result->fetch_object()) {
     ...
     echo "<div class='col-21' >
       <a href='RHM.php' class='previous'>&laquo; Previous</a> 
        &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;
        <a href='RHM.php? nb=$some' class='next'> Next &raquo;</a>
     </div>";
       ?>
 ...
 <!--   <div class="col-21" >
        ...
        &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;
        <a href="RHM 1.php" class="next"> Next &raquo;</a>
      </div>
