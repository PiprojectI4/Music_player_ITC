	...
	<nav class="navbar navbar-default">
	  ...
	  <div class="container-fluid">
	    ...
	    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	      ...
	      <form class="navbar-form navbar-right" method="post" action="pages/result.php">
      ...
      <div class='modal-content'>
        ...
        <div class='modal-body'>
          <div class='from-group'>
           <form enctype='multipart/form-data' action='pages/updateProduction.php' method='post'>
        ...
        <div class='modal-footer'>
          <button type='button' class='btn btn-default' data-dismiss='modal'>Cancel</button>
                  ...
                  <form action='pages/deleteProduct.php' method='post'>
 ...
 <table class="table table-bordered">
    ...
    <button type='button' class='btn btn-info btn-lg' data-toggle='modal' data-target='#myModal$i'>View</button>
      ...
      <div class='modal-content'>
        ...
        <div class='modal-body'>
          <div class='from-group'>
           <form enctype='multipart/form-data' action='pages/updateSong.php' method='post'>
        ...
        <div class='modal-footer'>
          <button type='button' class='btn btn-default' data-dismiss='modal'>Cancel</button>
                  ...
                  <form action='pages/deleteSong.php' method='post'>
    ...
    <div>
      <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal101010">add new song</button>
      <div class="modal fade" id="myModal101010" role="dialog">
    <div class="modal-dialog">
