  ...
  <div id="main">
    ...
    <article id="content">
      ...
      <div class="col-2">
       <a href="#" class="textColor"> <h2>RHM Production</h2></a>

         <?php
       require_once('dbconfig.php');
       
       $sql = "select * from production where name = 'RHM' ORDER BY vol desc limit 0, 3";
       $result = $conn->query($sql);
       while ($row = $result->fetch_object()) {
         echo "<div class='gallery'>
           <a class='' href='audio1.php? vol=$row->vol&amp;album=$row->name&amp;id=$row->id&amp;view=$row->view'>
              <img class='sizef' alt='RHM CD Vol $row->vol' src='../images/$row->local_img' >  
                <div class='desc' >RHM CD Vol $row->vol</div> 
          </a>
         </div> ";
       }
       ?>
      ...
      <div class="col-2">
          <a href="RHM.php? nb=0" class="more" style="">Read More</a>
      </div> 
      <div class="col-2">
        ...
        <?php
       require_once('dbconfig.php');
       $sql = "select * from production where name = 'SUNDAY' ORDER BY vol desc limit 0, 3";
       $result = $conn->query($sql);
       while ($row = $result->fetch_object()) {
         echo "<div class='gallery'>
           <a class='' href='audio1.php? vol=$row->vol&amp;album=$row->name&amp;id=$row->id&amp;view=$row->view'>
      ...
      <div class="col-2">
          <a href="Sunday.php" class="more" style="">Read More</a>
      </div>
      <div class="col-2">
          
        <h2>Khmer original</h2> 
         <?php
       require_once('dbconfig.php');
       $sql = "select * from production where type = 'original' and nationality = 'khmer' ORDER BY vol desc limit 0, 3";
       $result = $conn->query($sql);
       while ($row = $result->fetch_object()) {
         echo "<div class='gallery'>
           <a class='' href='audio1.php? vol=$row->vol&amp;album=$row->name&amp;id=$row->id&amp;view=$row->view'>
              <img class='sizef' alt='Khmer Original CD Vol $row->name' src='../images/$row->local_img' >  
      ...
      <div class="col-2">
          <a href="Original song.php" class="more" style="">Read More </a>
      </div>
      <div class="col-2">
          
        <h2>TOWN Production</h2> 
         <?php
       require_once('dbconfig.php');
       $sql = "select * from production where name = 'TOWN' ORDER BY vol desc limit 0, 3";
       $result = $conn->query($sql);
       while ($row = $result->fetch_object()) {
         echo "<div class='gallery'>
           <a class='' href='audio1.php? vol=$row->vol&amp;album=$row->name&amp;id=$row->id&amp;view=$row->view'>
              <img class='sizef' alt='RHM CD Vol 583' src='../images/$row->local_img' >  
                <div class='desc' >TOWN CD Vol $row->vol</div> 
          </a>
         </div> ";
       }
       ?>
      ...
      <div class="col-2">
          <a href="Town.php" class="more" style="">Read More</a><br><br>
      </div>
